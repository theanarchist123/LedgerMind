...
/**
 * Login page with working mock authentication
 * Demo credentials: demo@ledgermind.com / demo123
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setError("Invalid email or password. Try: demo@ledgermind.com / demo123")
      }
    } catch (err) {
        ...
        <CardHeader className="space-y-1">
          <div className="flex justify-center mb-4">
            <div className="relative w-12 h-12">
              ...
              <Receipt className="absolute inset-0 m-auto h-6 w-6 text-primary-foreground" />
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="text-xs text-muted-foreground bg-blue-50 dark:bg-blue-950/20 p-3 rounded-md border border-blue-200 dark:border-blue-800">
              <strong className="text-blue-700 dark:text-blue-400">Demo Credentials:</strong>
              <br />
              <span className="text-blue-600 dark:text-blue-300">Email: demo@ledgermind.com</span>
              <br />
              <span className="text-blue-600 dark:text-blue-300">Password: demo123</span>
            </div>
